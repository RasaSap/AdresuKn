...
public final class editAddress_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      String ids = request.getParameter("id");
        ...
        List<Address> addresses = null;
            try{
             ...
             addresses = DB.getPersonAddresses(id);
      ...
      out.print((addresses!=null)?addresses.get(id).getAddress():"");
      out.write("\"> \n");
      out.write("           <input name=\"city\" value=\"");
      out.print((addresses!=null)?addresses.get(id).getCity():"");
      out.write("\"> \n");
      out.write("           <input name=\"postalCode\" value=\"");
      out.print((addresses!=null)?addresses.get(id).getPostalCode():"");
      out.write("\"> \n");
      out.write("             ");
}catch(Exception ex){
                //ignore
      ...
      out.write("           <a href=\"addresses.jsp\">Cancel</a>\n");
      out.write("            \n");
      out.write("        </form>\n");
      out.write("    </body>\n");
      out.write("</html>\n");
